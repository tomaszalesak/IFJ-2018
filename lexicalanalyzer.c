    ...
    while (state != AS_DONE && state != AS_ERROR)
    {
        ...
        case AS_EMPTY:
            if (c == '_' || IS_CHAR(c)) {
                ...
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_ADD;
                state = AS_DONE;
            }
                ...
                token.type = T_OPERATOR;
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_SUB;
                state = AS_DONE;
            }
                ...
                token.type = T_OPERATOR;
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_MUL;
                state = AS_DONE;
            }
                ...
                token.type = T_OPERATOR;
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_DIV;
                state = AS_DONE;
            }
        ...
        case AS_OPERATOR_LT:
            if (c == '=') {
                token.type = T_OPERATOR;
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_LTE;
                state = AS_DONE;
            }
        ...
        case AS_OPERATOR_GT:
            if (c == '=') {
                token.type = T_OPERATOR;
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_GTE;
                state = AS_DONE;
            }
        ...
        case AS_OPERATOR_NOT:
            if (c == '=') {
                token.type = T_OPERATOR;
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_NEQ;
                state = AS_DONE;
            }
        ...
        case AS_OPERATOR_ASS:
            if (c == '=') {
                ...
                *(OperatorType*)(token.data) = OP_EQ;
                ...
                token.type = T_OPERATOR;
                token.data = malloc(sizeof(OperatorType));
                *(OperatorType*)(token.data) = OP_ASS;
                oldC = c;
                state = AS_DONE;
            }
